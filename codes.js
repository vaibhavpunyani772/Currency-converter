...
const countryList2 = {
  ...
  XCD: { code: "AG", country: "Antigua & Barbuda" },
  ALL: { code: "AL", country: "Albania" },
  AMD: { code: "AM", country: "Armenia" },
  ANG: { code: "AN", country: "Netherlands Antilles" }, // historic
  ...
  BAM: { code: "BA", country: "Bosnia & Herzegovina" },
  BBD: { code: "BB", country: "Barbados" },
  BDT: { code: "BD", country: "Bangladesh" },
  XOF: { code: "BE", country: "Belgium" }, // currency shared by West Africa, mapped to BE
  ...
  NOK: { code: "BV", country: "Bouvet Island" },
  BWP: { code: "BW", country: "Botswana" },
  BYR: { code: "BY", country: "Belarus" },
  BZD: { code: "BZ", country: "Belize" },
  CAD: { code: "CA", country: "Canada" },
  CDF: { code: "CD", country: "Democratic Republic of the Congo" },
  XAF: { code: "CF", country: "Central African Republic" }, // CFA franc (shared)
  ...
  ECS: { code: "EC", country: "Ecuador" }, // replaced by USD
  EEK: { code: "EE", country: "Estonia" }, // replaced by EUR
  EGP: { code: "EG", country: "Egypt" },
  ETB: { code: "ET", country: "Ethiopia" },
  EUR: { code: "FR", country: "France" }, // Euro is shared, mapped to FR
  ...
  LTL: { code: "LT", country: "Lithuania" }, // now uses EUR
  LVL: { code: "LV", country: "Latvia" }, // now uses EUR
  ...
  MRO: { code: "MR", country: "Mauritania" }, // replaced by MRU
  MTL: { code: "MT", country: "Malta" }, // now EUR
  ...
  TTD: { code: "TT", country: "Trinidad & Tobago" },
  ...
  VEF: { code: "VE", country: "Venezuela" }, // replaced by VES
  VND: { code: "VN", country: "Vietnam" },
  VUV: { code: "VU", country: "Vanuatu" },
  YER: { code: "YE", country: "Yemen" },
  ZAR: { code: "ZA", country: "South Africa" },
  ZMK: { code: "ZM", country: "Zambia" }, // replaced by ZMW
  ZWD: { code: "ZW", country: "Zimbabwe" }, // replaced by ZWL
};
